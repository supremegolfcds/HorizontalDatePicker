...
- (void)configureInset {
    //CGFloat inset = self.collectionView.bounds.size.width/2;
    self.collectionView.contentInset = UIEdgeInsetsMake(1, 1, 0, 1);
    self.collectionView.contentOffset = CGPointMake(1, 1);
}
